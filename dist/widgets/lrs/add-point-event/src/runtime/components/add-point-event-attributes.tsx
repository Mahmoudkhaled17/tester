...
export function AddPointEventAttributes (props: AddPointEventAttributesProps) {
  ...
  const { intl, widgetId, networkDS, network, eventDS, eventLayer, routeInfo, reset, jimuMapView, graphicsManager, conflictPreventionEnabled, onNavBack, hasConcurrencies, addToDominantRoute, concurrenciesResponse } = props
  ...
  const submitForm = async (locks?: LrsLocksInfo) => {
    ...
    await LrsApplyEdits(eventFeatureLayer, eventLayer, request, null, null)
