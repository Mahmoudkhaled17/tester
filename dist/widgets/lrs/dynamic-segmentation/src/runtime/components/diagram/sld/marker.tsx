...
export function Marker (props: MarkerProps) {
  ...
  const getAttributeToDisplayKeys = (): string[] => {
    return [...attributesToDisplay.keys()]
  }
  ...
  <div
    ...
    style={{ left: !isNaN(snapX) ? snapX : 0, pointerEvents: isPopupActive ? 'auto' : 'none' }}>
    <calcite-popover
        ...
        border: `1px solid ${colorUtils.colorMixOpacity(theme.sys.color.surface.overlayHint, 0.5)}`
          ...
          {isPopupActive && attributesToDisplay.size > 0 &&
             <div style={{
              ...
              {getAttributeToDisplayKeys().map((key) => {
                return (
                  <span key={key}>
                    <div
                      style={{
