...
import { DisplayType, type RouteInfoFromDataAction, type DynSegFieldInfo, type TableEdits, type OrientedImageryInfo, type SearchUnits } from '../../config'
...
const reducer = (state: DynSegRuntimeState, action) => {
  switch (action.type) {
    ...
    case 'SET_ORIENTED_IMAGERY_WIDGET_ID':
      return { ...state, orientedImageryWidgetId: action.value }
    case 'SET_SEARCH_TOLERANCE':
      return { ...state, searchTolerance: action.value }
    case 'SET_SEARCH_UNIT':
      return { ...state, searchUnit: action.value }
    case 'SET_ORIENTED_IMAGERY_INFO':
      return { ...state, orientedImageryInfo: action.value }
    case 'RESET_STATE':
      return {
        ...initialState,
        isLoading: true,
        ...
        orientedImageryWidgetId: state.orientedImageryWidgetId,
        searchTolerance: state.searchTolerance,
        searchUnit: state.searchUnit,
        orientedImageryInfo: state.orientedImageryInfo
      }
    default:
      return state
  }
