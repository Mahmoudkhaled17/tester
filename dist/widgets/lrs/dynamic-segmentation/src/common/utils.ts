...
export async function setValuesForView (settingsPerView: ImmutableObject<SettingsPerView>,
  ...
  if (!settingsPerView) {
    return constructSettingsPerView()
  }
  ...
  return settingsPerView
    ...
    .set('orientedImageryWidgetId', settingsPerView.orientedImageryWidgetId || '')
    .set('searchTolerance', settingsPerView.searchTolerance || 50)
    .set('searchUnit', settingsPerView.searchUnit || 'feet')
}
...
export function resetConfig (config: IMConfig, mode: ModeType): IMConfig {
  ...
  return config
    ...
    .set('defaultNetwork', '')
    .set('orientedImageryWidgetId', '')
    .set('searchTolerance', 50)
    .set('searchUnit', 'feet')
}
