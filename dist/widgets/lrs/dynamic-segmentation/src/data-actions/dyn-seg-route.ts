...
import { findNetworkInfoFromMapViewsConfig, isDefined, type NetworkInfo, getNetworkInfoFromLrsFeatureUrl } from 'widgets/shared-code/lrs'
...
export default class ExportJson extends AbstractDataAction {
  ...
  async onExecute (dataSets: DataRecordSet[], dataLevel: DataLevel): Promise<boolean> {
    ...
    const routeParams: RouteInfoFromDataAction = {
      ...
      fromMeasure: null,
      toMeasure: null,
      geometry: record.getGeometry() as __esri.Polyline | null
    }
