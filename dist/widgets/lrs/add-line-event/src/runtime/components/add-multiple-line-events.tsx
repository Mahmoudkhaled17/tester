...
import { Checkbox, FOCUSABLE_CONTAINER_CLASS, Label, Button, Tooltip } from 'jimu-ui'
...
export function AddMultipleLineEvents (props: AddMultipleLineEventsProps) {
  ...
  }, [lockInfo, selectedNetwork, selectedAttributeSet])
  ...
  const isValidRouteSelection = React.useMemo(() => {
    return isValidRouteSelectionUtil(routeInfo, Immutable(eventInfo), false, selectedNetwork, false)
  // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [routeInfo])
          ...
          >
            <div className="mt-auto ml-auto">
              <Button
                ...
                size="sm"
                disabled={(!isValidRouteSelection.isValid || tooltipMsg?.length > 0 ) && isReady}
                onClick={submitForm}
              >
