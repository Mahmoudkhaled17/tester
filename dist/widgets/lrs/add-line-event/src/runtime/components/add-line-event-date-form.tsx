        ...
        <div>
          ...
          <Tooltip title={fromDateToolTip}>
            <calcite-input-date-picker
              ...
              valueAsDate={routeInfo?.selectedFromDate ? new Date(routeInfo.selectedFromDate) : undefined}
          ...
          <Tooltip title={toDateToolTip}>
            <calcite-input-date-picker
              ...
              valueAsDate={routeInfo?.selectedToDate ? new Date(routeInfo.selectedToDate) : undefined}
