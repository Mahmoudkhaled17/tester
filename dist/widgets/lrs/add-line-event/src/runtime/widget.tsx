...
AllWidgetProps<IMConfig> & ExtraProps, State> {
  ...
  clearGraphics (): void {
    if (this && this.state) {
      ...
      this.state.graphicsManager.clearPickedToGraphic()
      this.state.graphicsManager.clearPickedConcurrencyGraphic()
  ...
  render () {
    ...
    return (
      <Paper variant='flat' shape="none" className="jimu-widget runtime-add-line-event surface-1 border-0">
        <div id={this.widgetOuterDivId} role='region' aria-label={this.getI18nMessage('_widgetLabel')} className="widget-outer-div h-100 w-100 d-flex">
