/** @jsx jsx */
import { React, jsx, hooks, css, type FeatureLayerDataSource, type DataRecord, type FeatureDataRecord, type ImmutableObject, type IntlShape, type ImmutableArray } from 'jimu-core'
...
export function SearchByRouteResultList (props: ResultsListProps) {
  ...
  return (
    <div className='list' css={getStyle(true)}>
      <div className='list_items mb-2 px-3' role='listbox' aria-label={getI18nMessage('results')}>
