/** @jsx jsx */
import { React, css, jsx, type DataSource, injectIntl, type IntlShape } from 'jimu-core'
  ...
  render () {
    return (
      <div className='item-feature-info-component d-flex align-items-center p-2' css={style}>
        <div className='flex-grow-1' onClick={this.toggleExpanded} ref={el => { this.refs.featureContainer = el }} />
      </div>
    )
  }
}
