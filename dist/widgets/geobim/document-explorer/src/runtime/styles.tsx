...
export const searchBox = (theme: IMThemeVariables): SerializedStyles => {
  return css({
    label: 'searchBox',
    flex: '1 1 auto',
    minWidth: '100px',
...
export const selectedTreeDocumentStyle = (
  ...
  return css(treeDocumentStyle(theme), {
    label: 'selectedTreeDocumentStyle',
    color: theme.sys.color.action.selected.text,
    backgroundColor: theme.sys.color.action.selected.default,

    '&:hover': {
      backgroundColor: theme.sys.color.action.selected.hover,
    },
  })
}
