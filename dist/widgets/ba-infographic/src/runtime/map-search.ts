...
export default class MapSearch {
  ...
  public static registerCallbacks (
    ...
    newMapData.searchControl._baFlag = true // mark our custom widget
    newMapData.searchControl.searchButton = false
    ...
    // Hide the submit button once the widget has rendered
    newMapData.searchControl.when(() => {
      const container = newMapData.searchControl.container as HTMLElement
      if (container) {
        const btn = container.querySelector<HTMLElement>('.esri-search__submit-button')
