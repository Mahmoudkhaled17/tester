...
describe('OpenWidgetsAction onExecute', () => {
  ...
  it('should support LocationChange in standard mode', () => {
    state.appRuntimeInfo.appMode = 0
    expect(action.filterMessageDescription({ messageType: MessageType.LocationChange } as any)).toBe(true)
  })

  it('should support LocationChange in express mode', () => {
    state.appRuntimeInfo.appMode = 1
    expect(action.filterMessageDescription({ messageType: MessageType.LocationChange } as any)).toBe(true)
  })
