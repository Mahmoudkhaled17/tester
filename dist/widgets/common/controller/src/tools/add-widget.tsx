...
import { appBuilderSync, isTranslationEditingRestrictedInState } from 'jimu-for-builder'
...
export default class AddWidget implements extensionSpec.ContextToolExtension {
  ...
  disabled () {
    return isTranslationEditingRestrictedInState(getAppStore().getState(), 'controller')
  }
