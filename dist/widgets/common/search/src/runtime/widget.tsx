...
const Widget = (props: SearchProps) => {
  ...
  const [selectedSuggestionItemId, setSelectedSuggestionItemId] = useState(null)
  ...
  const handleServiceListChange = (serviceList: IMServiceList, selectedSuggestionItemId?: string) => {
    if (selectedSuggestionItemId) {
      setSelectedSuggestionItemId(selectedSuggestionItemId)
    } else {
      setSelectedSuggestionItemId(null)
    }
