      ...
      <SettingRow>
        <div aria-label={nls('arrangementStyle')} role='radiogroup'>
          <Button
            ...
            aria-checked={config.arrangementStyle === ArrangementStyle.Style1}
          ...
          <Button
            ...
            aria-checked={config.arrangementStyle === ArrangementStyle.Style2}
          ...
          <Button
            ...
            aria-checked={config.arrangementStyle === ArrangementStyle.Style3}
