/** @jsx jsx */
import { css, type IMThemeVariables, jsx, React, type IntlShape, focusElementInKeyboardMode } from 'jimu-core'
...
export default function SearchConfigItem (props: Props) {
  const { widgetId, theme, itemCategoryInfo, defaultLabel, autoFocusCuratedFilter, onEnabledChange, onCustomLabelChange, onCuratedFilterChange, onDelete, translate } = props
