  ...
  const getLayoutSelection = () => {
    ...
    return (
      <div role='group' aria-label={nls('printLayout')}>
        {!isPremiumService && <div role='radiogroup'>
        ...
        {useServiceLayout && <SettingRow className={isPremiumService ? undefined : 'mt-3'}>
          <Select
        ...
        {(template?.layoutTypes === LayoutTypes.CustomLayout && supportCustomLayout) && <SettingRow className={isPremiumService ? undefined : 'mt-3'}>
          <AppItemSelector
            portalUrl={portalUrl}
