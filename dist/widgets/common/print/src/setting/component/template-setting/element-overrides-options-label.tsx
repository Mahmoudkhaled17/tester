...
import { checkIsElementOverrideItemAvailable, getTranslationNameForElementOverridesOption } from '../../../utils/utils'
...
const ElementOverridesOptionsLabel = (props: Props) => {
  ...
  if (!needDsSelector) {
    return getTranslationNameForElementOverridesOption(elementOverridesOption, translate)
  } else {
    ...
    return (<div className='d-flex w-100 align-item-center'>
      <span className='flex-grow-1'>{getTranslationNameForElementOverridesOption(elementOverridesOption, translate)}</span>
