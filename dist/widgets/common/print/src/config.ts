...
export const DATUM_TRANSFORMATION_WKID_LINK = 'https://developers.arcgis.com/rest/services-reference/enterprise/d1865ecb5d1b957bb92e4444f93d769c/gtf_pdf_12.1.pdf'
...
export interface ElementOverridesWithMapSurroundInfo {
  [key: string]: MapSurroundInfo
}

export type ElementOverrides = ElementOverridesWithMapSurroundInfo | object
...
export const DEFAULT_COMMON_SETTING = {
  ...
  datumTransformationWkid: null,
  datumTransformationWkidLabel: null,
  enableQuality: true,
  ...
  enableLegend: true,
  enableDatumTransformation: false,
  enableScalebarUnit: false,
...
export interface PrintTemplateProperties extends __esri.PrintTemplateProperties {
  ...
  wkid?: number | string
  datumTransformationWkid?: number | string
  label?: string
  ...
  enableDatumTransformation?: boolean
  ...
  wkidLabel?: string
  datumTransformationWkidLabel?: string
}
