/** @jsx jsx */
import { jsx, css, React, type DataSource, type IntlShape, type FeatureLayerDataSource, getAppStore, dateUtils, EsriFieldType } from 'jimu-core'
...
import { DATE_TIME_FORMAT, getLineInfo } from './utils'
  ...
  const initLayers = () => { // TODO: get initial layers in getTimeExtentForDS
    ...
    Object.keys(dataSources).forEach(dsId => {
      ...
      layers.push({
        ...
        extent: [start, end],
        extentLabels: [
          dateUtils.formatDateValueByEsriFormat(start, DATE_TIME_FORMAT, EsriFieldType.Date, intl),
          dateUtils.formatDateValueByEsriFormat(end, DATE_TIME_FORMAT, EsriFieldType.Date, intl)
        ]
      })
