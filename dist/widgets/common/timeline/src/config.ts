...
export interface timeSettings {
  ...
  speed?: TimeSpeed
  /**
   * for webmap ds, with or without Map widget.
   * currentTimeExtent is used to cache the play position extent when playPosition is 'SAVED' at runtime.
   */
  playPosition?: TimePlayPosition
