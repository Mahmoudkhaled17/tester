...
interface DataSourceProps {
  ...
  onIsDataSourceInfochanged: (dataSourceId: string, dataSourceStatus: DataSourceStatus) => void
...
export default class FilterItemDataSource extends React.PureComponent<DataSourceProps> {
  ...
  onDataSourceInfoChange = (info) => {
    ...
    this.props.onIsDataSourceInfochanged(this.props.useDataSource.dataSourceId, info?.status)
  }
