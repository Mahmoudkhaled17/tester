...
const Setting = (props: AllWidgetSettingProps<IMConfig>) => {
  ...
  const onEnableShortLinkChange = (e) => {
    props.onSettingChange({
      id: props.id,
      config: props.config.set('enableShortLink', e.target.checked)
    })
  }
  ...
  const renderPopupModeSetting = () => {
    ...
    const linkOptions = props.intl.formatMessage({ id: 'linkOptions', defaultMessage: nls.linkOptions })
    const showShortLink = props.intl.formatMessage({ id: 'showShortLink', defaultMessage: nls.showShortLink })
    ...
    const subSettingUI = (
      <React.Fragment>
        ...
        <SettingSection title={linkOptions} aria-label={linkOptions} role='group'>
          <SettingRow tag='label' label={showShortLink}>
            <Switch checked={props.config.enableShortLink ?? true} onChange={onEnableShortLinkChange} />
          </SettingRow>
        </SettingSection>
