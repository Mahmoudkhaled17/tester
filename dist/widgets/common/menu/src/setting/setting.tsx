        ...
        {advanced && (
          <React.Fragment>
            {type !== 'drawer' && <React.Fragment>
              <CollapsablePanel label={translate('navArrowColor')} aria-label={translate('navArrowColor')} defaultIsOpen={false} className='my-4 nav-arrow-color-collapse' wrapperClassName='pl-2'>
