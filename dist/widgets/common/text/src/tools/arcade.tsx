...
import codeOutlined from 'jimu-icons/svg/outlined/data/code.svg'
import codeFilled from 'jimu-icons/svg/filled/data/code.svg'
...
export default class TextTool implements extensionSpec.ContextToolExtension {
  ...
  getIcon (): any {
    return window.jimuConfig.isBuilder ? codeFilled : codeOutlined
  }
