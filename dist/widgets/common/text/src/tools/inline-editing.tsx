...
import { builderAppSync, isTranslationEditingRestrictedInState } from 'jimu-for-builder'
...
export default class TextTool implements extensionSpec.ContextToolExtension {
  ...
  disabled (): boolean {
    return isTranslationEditingRestrictedInState(getAppStore().getState(), 'text-edit')
  }
