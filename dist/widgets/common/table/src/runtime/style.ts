      ...
      .table-con{
        ...
        .esri-widget {
          ...
          vaadin-grid-cell-content:has(.esri-column__header-content) {
            ...
            calcite-action {
              --calcite-internal-action-padding-inline: 0.5rem;
              --calcite-internal-action-padding-block: 0.25rem;
              --calcite-action-background-color: transparent;
              --calcite-action-background-color-hover: rgba(0, 0, 0, .04);
            }
          }
          vaadin-grid {
            --_lumo-grid-border-color: ${theme.sys.color.divider.secondary};
            --_focus-ring-color: ${theme.sys.color.action.focus};
          }
          ...
          vaadin-grid-cell-content {
            ...
            --calcite-dropdown-item-background-color-hover: color-mix(in srgb, ${theme.sys.color.surface.overlay} 80%, black);
            --calcite-dropdown-item-text-color-press: ${theme.sys.color.surface.overlayText};
            color: unset;
            :hover {
              > a {
                color: ${theme.sys.color.action.selected.text};
            ...
            vaadin-grid-sorter {
              --vaadin-text-color-disabled: ${theme.sys.color.surface.paperText};
              --vaadin-text-color-secondary: ${theme.sys.color.surface.paperText};
              --vaadin-text-color: color-mix(in srgb, ${theme.sys.color.surface.paperText} 50%, white);
            }
          }
          vaadin-grid-cell-content {
          ...
          vaadin-grid::part(body-cell) {
            ...
            --vaadin-grid-cell-background: color-mix(in srgb, ${theme.sys.color.surface.paper} 80%, white);
          }
          vaadin-grid::part(body-cell):hover {
            --calcite-color-foreground-2: color-mix(in srgb, ${theme.sys.color.action.selected.default} 50%, white);
            color: ${theme.sys.color.action.selected.text};
          }
          vaadin-grid::part(selected-row-cell) {
            background-color: ${theme.sys.color.action.selected.default};
            color: ${theme.sys.color.action.selected.text};
            > a {
              color: ${theme.sys.color.surface.paperText};
            }
