...
import {
  MapViewManager, type JimuMapView, JimuMapViewComponent, type JimuLayerView, type JimuSubtypeGroupLayerView,
} from 'jimu-arcgis'
...
import { type SelectableJimuLayerView, isSupportedJimuLayerView, isExpressMode, getFinalAllowGeneratedForMap, sortDataSourceItemsByLayersOrder, getFinalEnableAttributeSelectionForMap } from '../../utils'
...

      {
        ...
        <React.Fragment>
          ...
          <Placeholder
            ...
            style={{ height: 'calc(100% - 15rem)', paddingTop: '20px' }}
          />
        </React.Fragment>
      }
