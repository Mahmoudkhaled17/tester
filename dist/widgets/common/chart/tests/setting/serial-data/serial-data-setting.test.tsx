...
describe('<SerialDataSetting />', () => {
  ...
  describe('<SerialDataSetting />', () => {
    ...
    it('should clean ui when change category type', async () => {
    ...
    it('should hide by field when template is combo', () => {
      ...
      const { getByText, queryByText } = render(<StatisticsDataSetting type='comboLineAndBarSeries' {...props} />)

      expect(getByText('By group')).toBeInTheDocument()
      expect(queryByText('By field')).not.toBeInTheDocument()
    })

    it('should force combo template with by-field query to render by-group controls', () => {
      const series = Immutable(ComboTemplate.series) as ImmutableArray<WebChartSeries>
      ...
      const { getByText, queryByText, getBySelector } = render(<StatisticsDataSetting type='comboLineAndBarSeries' {...props} />)

      expect(getByText('By group')).toBeInTheDocument()
      expect(queryByText('By field')).not.toBeInTheDocument()
      expect(getByText('Category field')).toBeInTheDocument()
      expect(getByText('Maximum categories')).toBeInTheDocument()
      expect(getBySelector(CategoryFieldSelector)).toBeInTheDocument()
    })
