import { EsriFieldType, type IMFeatureLayerQueryParams, Immutable, type ImmutableArray, JimuFieldType } from 'jimu-core'
  ...
  return {
    ...
    getFieldSchema: field => {
      if (field === 'Value1' || field === 'Value2') {
        return Immutable({ name: field, type: JimuFieldType.Number, esriType: EsriFieldType.Integer, fieldFormat: { type: 'number', maximumFractionDigits: 0, minimumFractionDigits: 0 } })
      }
...
describe('src/utils/common/schema.ts', () => {
  describe('getSerialSplitByFields', () => {
    ...
    it('should work well for by group for statistic count', () => {
      ...
      expect(res).toEqual({
        Year: { jimuName: 'Year', name: 'Year', originFields: ['Year'] },
        count_of_FID_of_ASSAULT: { jimuName: 'count_of_FID_of_ASSAULT', name: 'count_of_FID_of_ASSAULT', alias: 'Count of FID of ASSAULT', originFields: ['FID', 'Primary_Ty'], esriType: 'esriFieldTypeInteger', fieldFormat: { type: 'number', maximumFractionDigits: 0, minimumFractionDigits: 0 }, type: 'NUMBER' },
        count_of_FID_of_BATTERY: { jimuName: 'count_of_FID_of_BATTERY', name: 'count_of_FID_of_BATTERY', alias: 'Count of FID of BATTERY', originFields: ['FID', 'Primary_Ty'], esriType: 'esriFieldTypeInteger', fieldFormat: { type: 'number', maximumFractionDigits: 0, minimumFractionDigits: 0 }, type: 'NUMBER' },
        count_of_FID_of_ROBBERY: { jimuName: 'count_of_FID_of_ROBBERY', name: 'count_of_FID_of_ROBBERY', alias: 'Count of FID of ROBBERY', originFields: ['FID', 'Primary_Ty'], esriType: 'esriFieldTypeInteger', fieldFormat: { type: 'number', maximumFractionDigits: 0, minimumFractionDigits: 0 }, type: 'NUMBER' }
      })
    })
  ...
  describe('getSerialFields', () => {
    ...
    it('should work well for by group for statistic count', () => {
      ...
      expect(res).toEqual({
        Year: { jimuName: 'Year', name: 'Year', originFields: ['Year'] },
        count_of_FID: { jimuName: 'count_of_FID', name: 'count_of_FID', alias: 'Count of FID', esriType: 'esriFieldTypeInteger', originFields: ['FID'], fieldFormat: { type: 'number', maximumFractionDigits: 0, minimumFractionDigits: 0 }, type: 'NUMBER'}
      })
    })
    it('should work well for no aggregation', () => {
      const query = Immutable({
    ...
    it('should work well', () => {
      ...
      expect(res).toEqual({
        [HistogramMinValueField]: {
          ...
          fieldFormat: { useGrouping: 'always', maximumFractionDigits: 3, minimumFractionDigits: 3 }
        },
        ...
        [HistogramCountField]: {
          ...
          fieldFormat: { useGrouping: 'always', maximumFractionDigits: 0, minimumFractionDigits: 0 }
        }
      })
    })
  })
  ...
  describe('getScatterPlotFields', () => {
    ...
    it('should use double schema for number fields', () => {
      const query = Immutable({
        outFields: ['Value1', 'Value2']
      }) as IMFeatureLayerQueryParams
      const res = getScatterPlotFields(query, 'dataSourceId')
      expect(res).toEqual({
        Value1: { jimuName: 'Value1', name: 'Value1', originFields: ['Value1'], type: 'NUMBER', esriType: 'esriFieldTypeDouble', fieldFormat: { type: 'number', maximumFractionDigits: 3, minimumFractionDigits: 3 } },
        Value2: { jimuName: 'Value2', name: 'Value2', originFields: ['Value2'], type: 'NUMBER', esriType: 'esriFieldTypeDouble', fieldFormat: { type: 'number', maximumFractionDigits: 3, minimumFractionDigits: 3 } }
      })
    })
  })
})
