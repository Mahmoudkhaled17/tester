...
import type { ChartMessages, IWebChart, WebChartOrderOptions, WebChartSeries } from '../../../../../config'
...
import { autoUpdateChartTileIfNecessary } from '../../../../../utils/common'
...
const PieSetting = (props: PieSettingProps): React.ReactElement => {
  ...
  const orderOptions = propWebChart?.orderOptions as ImmutableObject<WebChartOrderOptions>
  ...
  const handleSeriesStatisticsChange = (series: ImmutableArray<WebChartSeries>, seriesRelatedProps: SeriesRelatedProps) => {
    ...
    webChart = autoUpdateChartTileIfNecessary(propWebChart, webChart, dataSourceId, translate)
