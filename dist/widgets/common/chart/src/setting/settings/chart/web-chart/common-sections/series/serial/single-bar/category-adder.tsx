...
export const CategoryAdder = (props: CategoryAdderProps): React.ReactElement => {
  ...
  return (
    <div className={classNames('category-adder', className)} css={style}>
      ...
      {editable && <div className='editor' role='group' aria-label={translate('addCategory')}>
        <div className='top-part'>
          <TextInput
            ref={ref}
            size='sm'
            aria-describedby='category-adder-tip'
        ...
        <div id='category-adder-tip' className='info-msg mt-1'>{translate('pressEnter')}</div>
      </div>}
    </div>
  )
}
