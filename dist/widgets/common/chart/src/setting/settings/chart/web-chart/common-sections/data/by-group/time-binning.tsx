import { React, classNames, hooks, type JimuFieldType } from 'jimu-core'
...
export const TimeBinning = (props: Props): React.ReactElement => {
  ...
  return (<div className={classNames('time-binning', className)}>
    <SettingRow label={translate('interval')} flow='wrap' className='mt-2'>
      <TimeInterval aria-label={translate('interval')} categoryFieldType={categoryFieldType} size={size} unit={unit} onChange={onTimeIntervalChange} />
    </SettingRow>
