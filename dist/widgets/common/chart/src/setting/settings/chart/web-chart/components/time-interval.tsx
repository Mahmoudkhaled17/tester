import { React, type JimuFieldType } from 'jimu-core'
...
export const TimeInterval = (props: TimeIntervalProps): React.ReactElement => {
  const { className, 'aria-label': ariaLabel, size, unit, categoryFieldType, onChange } = props

  const units = React.useMemo(() => {
    return getUnitsByFieldType(categoryFieldType)
  }, [categoryFieldType])
