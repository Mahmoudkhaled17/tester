...
export const PieSeriesSetting = (props: PieSeriesSettingProps): React.ReactElement => {
  ...
  const fetchNullValues = propSerie?.query?.fetchNullValues ?? false
  ...
  const [loadSlices, loading] = useLoadingPieSlices(dataSource, query, orderByFields, propSlices, colors, {
    numberLimit: totalNumberLimit,
    fetchNullValues
  })
