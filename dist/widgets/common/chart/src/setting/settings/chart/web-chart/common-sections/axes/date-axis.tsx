...
export const DateAxis = (props: DateAxisProps): React.ReactElement => {
  ...
  const { className, axis: propAxis, isHorizontal, labelBehavior: propLabelBehavior, hideAxisGrid = false, onChange, onLabelBehaviorChange } = props
  ...
  return (
    <div className={classNames('date-axis w-100', className)}>
      ...
      {!hideAxisGrid && <SettingRow tag='label' label={translate('axisGrid')} level={2} className='mt-4'>
