...
export const PieSliceNullValueSliceId = 'arcgis-charts-slice-id-null'
...
export const SingleSeriesOtherCategoryName = 'Undefined'
export const SingleSeriesOtherCategoryValue = '__other-category-value__'
...
export const DefaultOptions: ImmutableObject<ChartComponentOptions> = Immutable({ showEmptySeries: true })

// The version used for arcgis charts spec.
export const WebChartCurrentVersion = '25.0.0'
