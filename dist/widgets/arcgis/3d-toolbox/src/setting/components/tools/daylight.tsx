...
import { Switch, NumericInput, Radio, Label, defaultMessages as jimuUIMessages } from 'jimu-ui'
import defaultMessages from '../../translations/default'
import { SettingSection, SettingRow } from 'jimu-ui/advanced/setting-components'
import { type Tool3D, type DaylightConfig, DateOrSeason } from '../../../constraints'
import { AcitvedOnLoad } from './sub-comp/actived-on-load'
import { DefaultTimeSetting } from './sub-comp/daylight-default-time-setting'
...
export const Daylight = React.memo((props: Props) => {
  ...
  <React.Fragment>
    <SettingSection className='first-setting-section'>
      ...
      <DefaultTimeSetting toolConfig={props.toolConfig} onSettingChanged={_onSettingChanged}/>
