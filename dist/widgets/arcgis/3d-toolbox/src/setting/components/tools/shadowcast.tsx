...
import { DefaultTimePeriodSetting } from './sub-comp/shadowcast-default-time-period-setting'
...
export const ShadowCast = React.memo((props: Props) => {
  ...
  <React.Fragment>
    <SettingSection className='first-setting-section'>
      ...
      <DefaultTimePeriodSetting toolConfig={props.toolConfig} onSettingChanged={_onSettingChanged} />
    </SettingSection>
