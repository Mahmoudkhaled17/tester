...
import { Button, Checkbox, type ImageParam, Label, Loading, LoadingType, TextArea, TextInput, Tooltip, defaultMessages as jimuUIMessages } from 'jimu-ui'
...
export const AddBasemapsByUrlPopperContent = (props: AddBasemapsByUrlProps) => {
  ...
  return <div className='h-100 px-4 pb-4' css={style}>
    <div className='form-content d-flex flex-column'>
      ...
      <ul aria-label={translate('url')} className='urls-container pl-0 mt-4'>
