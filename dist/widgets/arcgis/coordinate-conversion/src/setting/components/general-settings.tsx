    ...
    return <div style={{ height: '100%', marginTop: '5px' }}>
      <div css={getGeneralSettingsStyle(this.props.theme)}>
        {this.state.apiLoaded &&
          <SettingRow role='group' aria-label={this.nls('locationSymbol') + ' ' + this.nls('symbolLocationHint')} label={this.nls('locationSymbol')} flow={'wrap'}>
            {symbol &&
              <SymbolSelector
        ...
        <SettingRow role='group' aria-label={this.nls('zoomScale')} label={this.nls('zoomScale')}>
          <Label>1 :</Label>
