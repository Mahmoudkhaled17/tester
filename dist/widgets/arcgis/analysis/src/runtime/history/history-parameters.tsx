...
import type PortalFolderType from '@arcgis/core/portal/PortalFolder'
...
const HistoryParameters = (props: Props) => {
  ...
  const [userFolders, setUserFolders] = useState<PortalFolderType[]>([])
