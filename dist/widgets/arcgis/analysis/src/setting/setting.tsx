...
import { getAnalysisComponentsAssetPath, useToolInfoStrings } from '../utils/strings'
...
const Setting = (props: SettingProps) => {
  ...
  useEffect(() => {
    import('@arcgis/analysis-components/dist/loader').then(({ defineCustomElements}) => {
      defineCustomElements(window, { resourcesUrl: getAnalysisComponentsAssetPath() })
    })
  }, [])
  ...
  useEffect(() => {
    loadArcGISJSAPIModules([
      ...
      const [PortalClz] = modules as [typeof Portal]

      const portal = new PortalClz({
        url: portalUrl,
