            ...
            <div className='popper-footer'>
              <div className='left-btn'>
                <Button
                  icon
                  type='tertiary'
                  onClick={this.toggleDrawTools}
                  title={isDrawToolsOpen ? this.formatMessage('pressToCollapse') : this.formatMessage('pressToExpand')}
                  aria-label={isDrawToolsOpen ? this.formatMessage('pressToCollapse') : this.formatMessage('pressToExpand')}
                  aria-expanded={isDrawToolsOpen}
                >
                  {isDrawToolsOpen
