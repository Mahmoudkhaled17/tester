            ...
            <Fragment>
              <SettingRow>
                ...
                <Tooltip title={this.formatMessage('initBookmarkTips')} showArrow placement='left'>
                  <Button icon type='tertiary' size='sm' className='ml-1 jimu-outline-inside'>
                    <InfoOutlined />
                  </Button>
                </Tooltip>
              </SettingRow>
              ...
              <AdvancedButtonGroup size='sm'>
                {
                  directions.map((data, i) => {
                    return (
                      ...
                      >
                        {data.icon === 'right' ? <ArrowRightOutlined size='s' autoFlip /> : <ArrowDownOutlined size='s' />}
                      </Button>
                    )
                  })
                }
  ...
  renderDataSetting = () => {
    ...
    return (
      <div className='bookmark-setting'>
        ...
        <SettingSection
          title={this.formatMessage('appearance')}
          aria-label={this.formatMessage('appearance')}
          role='group'
        >
          <SettingRow label={this.formatMessage('cardBackground')}>
            <ThemeColorPicker
              ...
              aria-label={this.formatMessage('cardBackground')}
            />
          </SettingRow>
          {runtimeAddType.includes(config.templateType) &&
            <SettingRow
              label={this.formatMessage('bookmarkTitleName')}
              aria-label={this.formatMessage('bookmarkTitleName')}
              flow='wrap'
              role='group'
            >
              <TextStyleSetting
          ...
          {slidesType.includes(config.templateType) &&
            <Fragment>
              <SettingRow
                label={this.formatMessage('bookmarkTitleName')}
                aria-label={this.formatMessage('bookmarkTitleName')}
