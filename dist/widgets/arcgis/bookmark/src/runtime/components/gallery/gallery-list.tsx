...
export function GalleryList (props: GalleryListProps) {
  const {
    config, bookmarks, runtimeBookmarkArray, runtimeBmItemsInfo, runtimeSnaps, highLightIndex, runtimeHighLightIndex,
    onViewBookmark, handleRuntimeTitleChange, onRuntimeBookmarkNameChange, onRuntimeAdd, onRuntimeDelete, isWebMap, widgetRect, showGalleryArrow
  } = props
  const {
    displayName,
    direction,
  ...
  return <React.Fragment>
    ...
    {showGalleryArrow && <NavButtons config={config} />}
  </React.Fragment>
}
