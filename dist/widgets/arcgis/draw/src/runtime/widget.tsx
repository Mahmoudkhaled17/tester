/** @jsx jsx */
import { React, jsx, type AllWidgetProps, useIntl, classNames, WidgetState } from 'jimu-core'
...
import { JimuDraw, type JimuDrawCreationMode, type JimuDrawVisibleElements, SnappingMode, type JimuDrawCreatedDescriptor } from 'jimu-ui/advanced/map'
...
function Widget (props: AllWidgetProps<IMConfig>): React.ReactElement {
  ...
  // Stop drawing when anchored windows are closed ,#/ExperienceBuilder-Web-Extensions/issues/29208
  ...
  React.useEffect(() => {
    // In the future, more statuses will be supported, such as "Closed," etc.
