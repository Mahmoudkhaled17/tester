import { dataSourceUtils, getAppStore, TimezoneConfig, dateUtils, type IntlShape, EsriFieldType } from 'jimu-core'
...
export const timestampFormat = (intl: IntlShape, utcTimestamp: number) => {
  ...
  return dateUtils.formatDateValueByEsriFormat(timestamp, dateUtils.DATE_TIME_DEFAULT_ESRI_FORMAT, EsriFieldType.Date, intl)
}
