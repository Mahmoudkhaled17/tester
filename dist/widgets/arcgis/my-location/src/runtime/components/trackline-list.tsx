...
class TrackLineList extends React.PureComponent<Props & ExtraProps> {
  ...
  render () {
    const trackContent = (this.props.trackLines.map((t, index) => {
      ...
      return (< TrackLineListItem key={index} theme={this.props.theme} dataSource={this.props.dataSource} track={t} active={this.props.selectedIds?.includes(t.OBJECTID)} onHandleSelect={this.props.onHandleSelect} onHandleDelete={this.props.onHandleDelete} ></TrackLineListItem >)
    }))
