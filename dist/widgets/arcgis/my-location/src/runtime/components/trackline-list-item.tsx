/** @jsx jsx */
import { type DataSource, React, classNames, css, injectIntl, jsx, type IMThemeVariables, type IntlShape } from 'jimu-core'
...
`
  ...
  render () {
    const fields = this.props.dataSource.getSchema()?.getIn(['fields'])
