...
export default class SetLocationMessageAction extends AbstractMessageAction {
  filterMessageDescription (messageDescription: MessageDescription): boolean {
    return messageDescription.messageType === MessageType.LocationChange ||
      (messageDescription.messageType === MessageType.DataRecordsSelectionChange && messageDescription.widgetId !== undefined)
  }
