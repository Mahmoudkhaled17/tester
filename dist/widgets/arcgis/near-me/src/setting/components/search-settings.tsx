...
import { defaultBufferDistance, unitOptions, expressModeUIVisibility } from '../constants'
  ...
  render () {
    return (
      <div css={getSearchSettingStyle(this.props.theme)} style={{ height: '100%', width: '100%' }}>
        <React.Fragment>
          <SettingRow role='group' aria-label={this.nls('searchByActiveMapArea')} flow='wrap'>
          ...
          <SettingRow className={'mt-2'} role='group' aria-label={this.nls('searchByLocation')} flow='wrap'>
            <Label className='m-0' centric>
              <Radio className={'cursor-pointer'}
          ...
          <SettingRow role='group' aria-label={this.nls('headingLabel')} className='ml-2' flow={'wrap'}>
            <Label title={this.nls('headingLabel')}
          ...
          {this.props.config.searchByActiveMapArea &&
            <SettingRow role='group' aria-label={this.nls('featuresOutsideMapArea') + ' '+ (this.props.config.includeFeaturesOutsideMapArea && this.props.config.searchByActiveMapArea ?
              this.nls('searchAreaHint') : '')} tag='label' className='ml-2' label={this.nls('featuresOutsideMapArea')}>
              <Switch title={this.nls('featuresOutsideMapArea')}
          ...
          {!this.props.config.searchByActiveMapArea &&
            <React.Fragment>
              <SettingRow role='group' aria-label={this.nls('bufferDistance')} className={'mt-4 ml-2'} flow={'wrap'}>
                ...
                <NumericInput style={{ width: '240px' }}
              ...
              <SettingRow role='group' aria-label={this.nls('distanceUnits')} className={'ml-2'} flow={'wrap'}>
                ...
                <Select style={{ marginBottom: '1px' }} aria-label={this.props.config.distanceUnits !== '' ? this.props.config.distanceUnits : getPortalUnit()}
              ...
              {expressModeUIVisibility.activateToolOnLoad &&
                <React.Fragment>
                  <SettingRow>
                    ...
                    <Tooltip title={this.nls('activateToolOnLoadTooltip')} showArrow placement='top'>
                      <div className='title3 text-default mr-2 d-inline'>
                        <InfoOutlined />
                      </div>
                    </Tooltip>
                  </SettingRow>
                  <SettingRow role='group' aria-label={this.nls('activateToolOnLoadLabel') + ' ' + this.nls('activateToolOnLoadTooltip')}>
              ...
              {expressModeUIVisibility.inputSettingsSection &&
                <SettingRow className='border-top pt-3'>
                  <CollapsablePanel
                    aria-label={this.nls('inputsCollapsible')}
                    ...
                    <div style={{ height: '100%', marginTop: 10 }}>
                      <SettingRow role='group' aria-label={this.nls('showDistanceSettings')}>
                        <Label check centric style={{ cursor: 'pointer' }}>
                          <Checkbox style={{ cursor: 'pointer' }} className='mr-2' checked={this.props.config.showDistanceSettings}
                      ...
                      <SettingRow role='group' aria-label={this.nls('inputAddress')}>
                        <Label check centric style={{ cursor: 'pointer' }}>
                          <Checkbox style={{ cursor: 'pointer' }} className='mr-2' checked={this.props.config.showInputAddress}
                      ...
                      <SettingRow role='group' aria-label={this.nls('showSketchTools') + ' ' + this.nls('point')} className='mt-2 mx-2'>
                      ...
                      <SettingRow role='group' aria-label={this.nls('showSketchTools') + ' ' + this.nls('polyline')} className='mt-1 mx-2'>
                      ...
                      <SettingRow role='group' aria-label={this.nls('showSketchTools') + ' ' + this.nls('polygon')} className='mt-1 mx-2'>
