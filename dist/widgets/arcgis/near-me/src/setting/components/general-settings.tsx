...
export default class GeneralSetting extends React.PureComponent<Props, State> {
  ...
  /**
   * On url parameters option change update the setting
   * @param evt get the event on toggle the url parameters option
   */
  onUrlParamtersOptionChange = (evt: React.ChangeEvent<HTMLInputElement>) => {
    this.props.onGeneralSettingsUpdated('urlParametersEnabled', evt.target.checked)
  }
  ...
  render () {
    ...
    return (
      <div css={getGeneralSettingStyle(this.props.theme)} style={{ height: '100%', width: '100%', marginTop: 10 }}>
        <SettingRow role='group' aria-label={this.nls('highlightColor') + ' ' + this.nls('highlightColorTooltip')}>
          <Label className='w-100 d-flex'>
            <div className='flex-grow-1 text-break title3 hint-default'>
              {this.nls('highlightColor')}
            </div>
          </Label>
          <Tooltip title={this.nls('highlightColorTooltip')} showArrow placement='top'>
        ...
        <SettingRow role='group' aria-label={this.nls('searchAreaSymbolLabel') + ' ' + this.nls('searchAreaSymbolTooltip')}>
          <Label className='w-100 d-flex'>
            <div className='flex-grow-1 text-break title3 hint-default'>
              {this.nls('searchAreaSymbolLabel')}
            </div>
          </Label>
          <Tooltip title={this.nls('searchAreaSymbolTooltip')} showArrow placement='top'>
            <div className='title3 text-default mr-4 d-inline'>
              <InfoOutlined />
            </div>
          </Tooltip>
        ...
        <SettingRow role='group' aria-label={this.nls('keepResultsWhenClosed') + ' ' + this.nls('keepResultsWhenClosedTooltip')}>
          <Label className='w-100 d-flex'>
            <div className='flex-grow-1 text-break title3 hint-default'>
              {this.nls('keepResultsWhenClosed')}
            </div>
          </Label>
          <Tooltip title={this.nls('keepResultsWhenClosedTooltip')} showArrow placement='top'>
            <div className='title3 text-default mr-3 d-inline'>
              <InfoOutlined />
            </div>
          </Tooltip>
          <Switch title={this.nls('keepResultsWhenClosed')}
            checked={this.props.config.keepResultsWhenClosed} onChange={this.onKeepResultOptionChange.bind(this)} />
        </SettingRow>

        <SettingRow role='group' aria-label={this.nls('urlParametersLabel') + ' ' + this.nls('urlParametersTooltip')}>
          <Label className='w-100 d-flex'>
            <div className='flex-grow-1 text-break title3 hint-default'>
              {this.nls('urlParametersLabel')}
            </div>
          </Label>
          <Tooltip title={this.nls('urlParametersTooltip')} showArrow placement='top'>
            <div className='title3 text-default mr-3 d-inline'>
              <InfoOutlined />
            </div>
          </Tooltip>
          <Switch title={this.nls('urlParametersLabel')}
            checked={this.props.config.urlParametersEnabled} onChange={this.onUrlParamtersOptionChange.bind(this)} />
        </SettingRow>

        <SettingRow role='group' aria-label={this.nls('noResultsFoundLabel')} flow={'wrap'}>
          <Label title={this.nls('noResultsFoundLabel')}
        ...
        <SettingRow role='group' aria-label={this.nls('promptMessageLabel') + ' ' + this.nls('promptMessageLabelToolTip')} flow='wrap'>
          <Label title={this.nls('promptMessageLabel')}
            className='d-flex promptMessageLabel'>
            <div className='flex-grow-1 text-break title3 hint-default'>
              {this.nls('promptMessageLabel')}
            </div>
          </Label>
          <Tooltip title={this.nls('promptMessageLabelToolTip')} showArrow placement='top'>
          ...
          <TextFormatSetting
            ...
            promptTextMessage={'promptMessage'}
