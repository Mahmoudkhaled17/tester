...
*/
export const getHighLightSymbol = (graphic: Graphic, color?: string): Graphic => {
...
*/
const getPointSymbol = (graphic: Graphic, color: string): Graphic => {
...
*/
const getPolyLineSymbol = (graphic: Graphic, color: string): Graphic => {
  const layer: any = graphic.layer
...
*/
const getPolygonSymbol = (graphic: Graphic, color: string): Graphic => {
  const symbolPolygon = {
    type: 'simple-fill',
    color: [0, 255, 255, 0],
    style: 'solid',
