        ...
        <TextInput
          ...
          onAcceptValue={value => {
            if (value !== this.props.dsConfig?.label) {
              const dataSource = DataSourceManager.getInstance().getDataSource(this.props.dsConfig?.useDataSourceId)
              const defaultLabel = dataSource?.getLabel()
              if (!value) {
                this.setState({ label:  defaultLabel})
              }
              this.props.onLabelChange(this.props.dsConfig?.id, value || defaultLabel)
            }
          }}
