...
export function getStyle (theme: IMThemeVariables, styleType: StyleType, styleConfig: StyleConfig, isRTL: boolean, autoWidth: boolean, enableNavDS: boolean): SerializedStyles {
  ...
  let isCustomStyleColor = false
  let isCustomStyleFontSize = false
  if (styleType === 'custom') {
    //isCustomStyle = !!styleConfig.textColor || !!styleConfig.fontSize
    isCustomStyleColor = !!styleConfig.textColor
    isCustomStyleFontSize = !!styleConfig.fontSize
  ...
  return css`
    .widget-featureInfo{
      ...
      .esri-features {
        --calcite-color-background: ${containerColor};
      }
      ...
      .feature-info-component{
        ...
        .esri-widget * ${isCustomStyleFontSize ? '' : ':not(.esri-feature-content *, .esri-features__heading *)'} {
          font-size: ${fontSize} !important;
        }
        .esri-widget * ${isCustomStyleColor ? '' : ':not(.esri-feature-content *, .esri-features__heading *, a[href])'} {
        ...
        .esri-feature-content a[href], .esri-widget__table a[href] {
