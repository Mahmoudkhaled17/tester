 ...
 * Note: Swipe API does not support for group layer and knowledge graph layer.
 */
export const isLayersDisabled = (jimuLayerView: JimuLayerView): boolean => {
  return jimuLayerView.type === JSAPILayerTypes.GroupLayer || jimuLayerView.type === JSAPILayerTypes.KnowledgeGraphLayer
}
