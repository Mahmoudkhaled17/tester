...
const Widget = (props: AllWidgetProps<IMConfig>) => {
  ...
  const { styleConfig, scrollMapViewList, swipeMapViewList, mapUseDataSourcesOrderList, swipeStyle, swipeMode, leadingLayersAlias, trailingLayersAlias } = config
  const {
      ...
      <div className={classNames(`swipe-panel useMapWidgetId-${useMapWidgetId}`)}>
        ...
        { showSwipeBetweenLayersPanel && isRuntimeSwipeLayerUpdated &&
          <SwipeBetweenLayersPanel
            ...
            activeMapView={activeMapView}
            leadingLayersAlias={leadingLayersAlias}
            trailingLayersAlias={trailingLayersAlias}
            isAllowDeactivateLayers={isAllowDeactivateLayers}
            toggleLayerVisibility={toggleLayerVisibility}
