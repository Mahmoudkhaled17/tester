  ...
  fixBreakpoints (type: string) {
    ...
    setTimeout(() => {
      ...
      if (vm && (type === 'both' || type === 'widthBreakpoint')) {
        ...
        this.coreContainer.classList.remove("esri-view-width-less-than-small")
        if (size === "xsmall") {
          this.coreContainer.classList.add("esri-view-width-less-than-small")
        }
      }
      if (vm && (type === 'both' || type === 'heightBreakpoint')) {
        vm._viewHeightBreakpoint = size
        this.coreContainer.classList.remove("esri-view-height-less-than-small")
        if (size === "xsmall") {
          this.coreContainer.classList.add("esri-view-height-less-than-small")
        }
      }
    }, 100)
  }
