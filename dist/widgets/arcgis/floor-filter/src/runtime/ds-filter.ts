...
export default class DsFilter {
  ...
  init (jimuMapView: JimuMapView, foorFilterWidget, coreFloorFilterWidget): void {
    ...
    const widgetId = foorFilterWidget?.props?.id
    const filterDataSources = !!(foorFilterWidget?.props?.config?.filterDataSources)
    const filterByActiveFloorOnly = !!(foorFilterWidget?.props?.config?.filterByActiveFloorOnly)
    const autoSetOnFeatureSelection = !!(foorFilterWidget?.props?.config?.autoSetOnFeatureSelection)
    const zoomOnAutoSet = !!(foorFilterWidget?.props?.config?.zoomOnAutoSet)
    this.widgetId = widgetId
    this.filterDataSources = filterDataSources
    this.filterByActiveFloorOnly = filterByActiveFloorOnly
    this.autoSetOnFeatureSelection = autoSetOnFeatureSelection
    this.zoomOnAutoSet = zoomOnAutoSet
