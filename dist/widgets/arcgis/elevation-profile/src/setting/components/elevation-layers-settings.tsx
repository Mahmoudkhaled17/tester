      ...
      <div className={classNames('flex-grow-1 layer-data-item cursor-pointer')} key={index}>
        <div className='d-flex w-100 justify-content-between align-items-center'>
          ...
          {item.id === this.props.config.groundLayerId &&
            <Tooltip title={this.nls('groundLayerInfoTooltip')} showArrow placement='top' data-testid={'groundLayerInfoIcon'}>
  ...
  render () {
    ...
    return <div style={{ height: '100%', width: '100%', marginTop: 5 }} css={getElevationLayersSettingsStyle(this.props.theme)}>
      ...
      <div ref={this.elevationLayerSidePopperTrigger} className='mb-4'>
        <SettingRow role='group' aria-label={this.nls('newLayerLabel')}>
        ...
        {this.state.addedElevationLayers.length === 0 &&
          <SettingRow role='group' aria-label={this.nls('noGroundLayerInfoMessage')}>
            <Alert
              style={{ minWidth: 'auto' }}
              open={true}
        ...
        {this.state.addedElevationLayers.length > 0 &&
          <React.Fragment>
            <SettingRow label={this.nls('setGroundLayer')}>
              <Tooltip title={this.nls('setGroundLayerTooltip')} showArrow placement='top'>
                <div className='ml-2 d-inline'>
                  <Icon size={14} icon={epConfigIcon.infoIcon} />
                </div>
              </Tooltip>
            </SettingRow>
            <SettingRow role='group' aria-label={this.nls('setGroundLayer') + ' ' + this.nls('setGroundLayerTooltip')}>
              <Select size={'sm'}
        ...
        {this.mapView?.view?.type === '3d' &&
          <SettingRow role='group' aria-label={this.nls('volumetricObjectsLabel') + ' ' + this.nls('volumetricObjectsTooltip')}>
            ...
            <Tooltip title={this.nls('volumetricObjectsTooltip')} showArrow placement='top'>
      ...
      <SettingRow role='group' aria-label={this.nls('measurementUnitsHeadingLabel') + ' ' + this.nls('measurementUnitsHeadingTooltip') + ' ' + this.nls('elevationUnitLabel')}>
        <Label className='d-flex' style={{ width: 108 }}>
      ...
      <SettingRow role='group' aria-label={this.nls('measurementUnitsHeadingLabel') + ' ' + this.nls('measurementUnitsHeadingTooltip') + ' ' + this.nls('distanceUnitLabel')}>
        <Label style={{ width: 108 }} className='d-flex'>
          <div className='flex-grow-1 text-break title3 hint-default'>
