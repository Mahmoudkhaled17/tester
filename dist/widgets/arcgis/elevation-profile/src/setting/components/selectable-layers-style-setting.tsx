    ...
    return <div style={{ height: '100%', width: '100%', marginTop: 5 }} css={getSelectableLayersSettingsStyle(this.props.theme)}>
      <div>
        <SettingRow className='pt-4 ep-divider-top' label={this.nls('selectionModeLabel')}>
          <Tooltip title={this.nls('nextSelectableTooltip')} showArrow placement='top'>
        ...
        <SettingRow role='group' aria-label={this.nls('selectionModeLabel') + ' '+ this.nls('nextSelectableTooltip')}>
        ...
        {this.props.config.selectionModeOptions?.selectionMode === SelectionMode.Multiple &&
          <SettingRow role='group' aria-label={this.nls('nextSelectableOptionLabel')} flow='wrap'>
        ...
        <SettingRow role='group' aria-label={this.nls('supportAddedLayers') + ' ' + this.nls('supportAddedLayersTooltip')}>
          <Label className='w-100 d-flex cursor-pointer'>
            <Checkbox className={'mr-2 font-13'} checked={this.props.config.supportAddedLayers}
              onChange={this.onAddedLayersOptionChange} data-testid='supportAddedLayersOption'/>
            <div className='flex-grow-1 text-break'>
              {this.nls('supportAddedLayers')}
            </div>
          </Label>
          <Tooltip title={this.nls('supportAddedLayersTooltip')} showArrow placement='top'>
