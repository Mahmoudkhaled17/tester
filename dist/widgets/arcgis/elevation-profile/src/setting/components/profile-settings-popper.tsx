  ...
  render () {
    ...
    return <div style={{ height: '100%', width: '100%' }} css={getAdvanceSettingsStyle(this.props.theme)}>
      <SettingSection>
        ...
        <SettingRow role='group' aria-label={this.nls('valueType') + ' ' + selectedValueTypeHint}>
        ...
        <SettingRow role='group' aria-label={this.nls('valueUnit')} className={this.state.elevationType === 'no elevation' || this.state.elevationType === 'z' ? 'hidden' : ''}>
          <Label className='flex-grow-1 ep-label'>
            <div className='flex-grow-1 text-break title3 hint-default'>
              {this.nls('valueUnit')}
            </div>
        ...
        {this.props.config.distanceSettings.type !== 'map' &&
          <React.Fragment>
            <SettingRow role='group' aria-label={this.nls('distanceSettingLabel')} className={'pt-4 ep-divider-top'}>
              <Label className='w-100 d-flex'>
                <div className='flex-grow-1 text-break color-label title2 hint-paper'>
            ...
            <SettingRow role='group' aria-label={this.nls('distanceSettingsWarning')}>
        ...
        <SettingRow role='group' aria-label={this.nls('styleLabel') + ' ' + this.nls('styleLineTooltip')}>
          <LineStylePicker
