...
export default class GeneralSettings extends React.PureComponent<Props, IState> {
  ...
  render () {
    ...
    return <div style={{ height: '100%', width: '100%', marginTop: 5 }} css={getGeneralSettingsStyle(this.props.theme)}>
      <SettingRow role='group' aria-label={this.nls('allowExportLabel')} tag='label' label={this.nls('allowExportLabel')}>
        <Switch
      ...
      <SettingRow role='group' aria-label={this.nls('appearanceCollapsible')}>
        <CollapsablePanel
          ...
          <div style={{ height: '100%', marginTop: 10 }}>
            ...
            <SettingRow role='group' aria-label={this.nls('showChartGridsLabel')} tag='label' label={this.nls('showChartGridsLabel')}>
              <Switch
            ...
            <SettingRow role='group' aria-label={this.nls('showChartAxisTitlesLabel')} tag='label' label={this.nls('showChartAxisTitlesLabel')}>
              <Switch
            ...
            <SettingRow role='group' aria-label={this.nls('showLegend')} tag='label' label={this.nls('showLegend')}>
              <Switch
