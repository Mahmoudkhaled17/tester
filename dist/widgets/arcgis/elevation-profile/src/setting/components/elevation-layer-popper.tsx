  ...
  render () {
    return <div style={{ height: 'calc(100% - 92px)', width: '100%', overflow: 'auto' }} css={getElevationLayersSettingsStyle(this.props.theme)}>
      <SettingSection>
        {!this.props.isVolumetricObjSettings &&
          <React.Fragment>
            <SettingRow className={'pt-1'}>
              ...
              <Tooltip title={this.nls('selectLayerTooltip')} showArrow placement='top'>
            ...
            {(!this.props.isNewLayerAdded && !this.state.useDataSource) &&
              <SettingRow role='group' aria-label={this.nls('selectLayer') + ' ' + this.nls('selectLayerTooltip')} >
        ...
        <SettingRow role='group' aria-label={this.nls('label') + ' ' + this.state.elevationLayerLabel} className={classNames(!this.props.isVolumetricObjSettings ? 'ep-divider-top pt-4' : 'pt-1')} label={this.nls('label')} flow={'wrap'}>
          <TextInput data-testid='layerLabel' className='w-100' title={this.state.elevationLayerLabel}
        ...
        <SettingRow className={'pt-4 ep-divider-top'}>
          ...
          <Tooltip title={this.nls('elevationLayerStyleTooltip')} showArrow placement='top'>
            <div className='ml-2 d-inline'>
              <Icon size={14} icon={epConfigIcon.infoIcon} />
            </div>
          </Tooltip>
        ...
        <SettingRow role='group' aria-label={this.nls('styleLabel') + ' ' + this.nls('elevationLayerStyleTooltip')}>
          <LineStylePicker
        ...
        <SettingRow role='group' aria-label={this.nls('displayGroundProfileStatsLabel')} tag='label' label={this.nls('displayGroundProfileStatsLabel')}>
          <Switch
