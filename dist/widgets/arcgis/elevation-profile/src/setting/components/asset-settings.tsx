  ...
  render () {
    ...
    return <div css={getAdvanceSettingsStyle(this.props.theme)} style={{ height: '100%', width: '100%', marginTop: 5 }}>
      <SettingRow>
        ...
        <Tooltip title={this.nls('intersectingLayersTooltip')} showArrow placement='top'>
      ...
      <SettingRow role='group' aria-label={this.state.selectedLayers.length === 0 && this.nls('intersectingLayersWarning')}>
      ...
      {this.state.selectedLayers.length === 0 &&
        <SettingRow>
          <Label className='hint w-100 d-flex'>
      ...
      <SettingRow role='group' aria-label={this.nls('intersectingBufferSettingsLabel') + ' ' + this.nls('intersectingBufferSettingsTooltip')}>
        <Label className='w-100 d-flex cursor-pointer'>
          <Checkbox className={'mr-2 font-13'} checked={this.props.config.assetIntersectingBuffer?.enabled}
            onChange={this.onIntersectingBufferChange} />
          <div className='flex-grow-1 text-break'>
            {this.nls('intersectingBufferSettingsLabel')}
          </div>
        </Label>
        <Tooltip title={this.nls('intersectingBufferSettingsTooltip')} showArrow placement='top'>
