  ...
  render () {
    ...
    return <div css={getAdvanceSettingsStyle(this.props.theme)} style={{ height: '100%', width: '100%', marginTop: 5 }}>
      <SettingRow>
        ...
        <Tooltip title={this.nls('selectableLayersTooltip')} showArrow placement='top'>
      ...
      <SettingRow role='group' aria-label={this.state.selectedLayers.length === 0 && this.nls('selectableLayersWarning')}>
