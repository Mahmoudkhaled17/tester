...
export default class AssetSettingPopper extends React.PureComponent<Props, IState> {
  ...
  render () {
    ...
    return <div style={{ height: '100%', width: '100%' }} css={getAdvanceSettingsStyle(this.props.theme)}>
      <SettingSection>
        <SettingRow role='group' aria-label={this.nls('elevationSettingLabel')} className={'pt-1'}>
        ...
        <SettingRow role='group' aria-label={this.nls('valueType') + ' ' + selectedValueTypeHint} className={'pt-2'}>
          <Label className='flex-grow-1 ep-label'>
        ...
        <SettingRow role='group' aria-label={this.nls('oneFieldLabel')} className={this.state.elevationType === 'one' || this.state.elevationType === 'two' ? '' : 'hidden'}>
        ...
        <SettingRow role='group' aria-label={this.nls('twoFieldLabel')} className={this.state.elevationType === 'two' ? '' : 'hidden'}>
          <div className={'left-and-right d-flex justify-content-between w-100'}>
            <Label className='flex-grow-1 ep-label'>
              <div className='flex-grow-1 text-break title3 hint-default'>
        ...
        <SettingRow role='group' aria-label={this.nls('valueUnit')} className={(this.state.elevationType === 'no elevation' || this.state.elevationType === 'z' ||
        this.state.elevationType === 'match profile')
          ...
          <Select className={'selectOption'} name={'valueunit'}
        ...
        <SettingRow className={'pt-4 ep-divider-top'}>
          ...
          <Tooltip title={this.nls('displayFieldTooltip')} showArrow placement='top'>
            <div className='ml-2 d-inline'>
              <Icon size={14} icon={epConfigIcon.infoIcon} />
            </div>
          </Tooltip>
        ...
        <SettingRow role='group' aria-label={this.nls('displayFieldLabel') + ' '+ this.nls('displayFieldTooltip')}>
          <FieldSelector
            dataSources={[this.props.selectedLayerDataSource.layer]}
        ...
        <SettingRow role='group' aria-label={this.nls('styleLabel') + ' ' + this.nls('stylePointTooltip')} className={'pt-4 ep-divider-top'}>
          <Label className='w-100 d-flex'>
            <div className='flex-grow-1 text-break color-label title2 hint-paper'>
              {this.nls('styleLabel')}
            </div>
          </Label>
          <Tooltip title={this.nls('stylePointTooltip')} showArrow placement='top'>
            <div className='ml-2 d-inline'>
              <Icon size={14} icon={epConfigIcon.infoIcon} />
            </div>
          </Tooltip>
        ...
        <SettingRow role='group' aria-label={this.nls('symbology')} className='hidden'>
          <Label className='flex-grow-1 ep-label'>
            <div className='flex-grow-1 text-break title3 hint-default'>
              {this.nls('symbology')}
            </div>
