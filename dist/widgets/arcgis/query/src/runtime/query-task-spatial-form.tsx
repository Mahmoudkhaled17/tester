...
export interface QueryTaskItemProps {
  ...
  stateCount: number // used to reset internal state when the form is reset
...
export function QueryTaskSpatialForm (props: QueryTaskItemProps) {
  const {
    ...
    dsEnableBuffer, dsBufferDistance, dsBufferUnit, drawEnableBuffer, drawBufferDistance, drawBufferUnit, createToolTypes, widgetId, stateCount
  } = props
  ...
  const resetFilterType = React.useEffectEvent(() => {
