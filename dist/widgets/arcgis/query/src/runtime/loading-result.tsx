  ...
  return (
    <Root>
      <div className='loading-content w-100 px-4 d-flex flex-column justify-content-center align-items-center'>
        <div className='text-paper'>{translate('retrieving')}</div>
        <Loading className='loading-tip mt-8' type={LoadingType.Donut} useAriaLive={true} aria-label={translate('retrieving')} />
      </div>
    </Root>
  )
}
