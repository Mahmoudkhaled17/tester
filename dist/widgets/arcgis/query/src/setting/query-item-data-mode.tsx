/** @jsx jsx */
import { React, jsx, css, classNames, type ImmutableObject, Immutable, DataSourceManager, type UseDataSource, CONSTANTS, type IMDataSourceJson, DataSourceTypes, hooks, focusElementInKeyboardMode } from 'jimu-core'
...
const dsTypes = Immutable([DataSourceTypes.FeatureLayer, DataSourceTypes.KnowledgeGraphSublayer])
