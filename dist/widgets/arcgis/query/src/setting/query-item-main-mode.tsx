        ...
        {queryItem && dsExists && (
          <React.Fragment>
            ...
            <AttributeFilterSetting
              key={`${queryItem.configId}_${queryItem.useDataSource.dataSourceId}_attr`}
              queryItem={queryItem}
              onPropertyChanged={updateProperty}
              onQueryItemChanged={updateItem}
            />
            <SpatialFilterSetting
              key={`${queryItem.configId}_${queryItem.useDataSource.dataSourceId}_spatial`}
              queryItem={queryItem}
              onPropertyChanged={updateProperty}
              handleStageChange={handleStageChangeInSpatialFilter}
            />
            <ResultsSetting
              key={`${queryItem.configId}_${queryItem.useDataSource.dataSourceId}_result`}
              widgetId={widgetId}
              queryItem={queryItem}
              onPropertyChanged={updateProperty}
              onQueryItemChanged={updateItem}
