            ...
            {this.state.flyManagerItems.map((itemConfig, idx) => {
              ...
              if (FlyItemMode.Rotate === style) {
                return (
                  <div key={idx}>
                    <DropdownItem
                      className='dropdown-items' title={rotateTips} aria-label={rotateTips}
                ...
                return (
                  <div key={idx}>
                    <DropdownItem
                      className='dropdown-items' title={pathTips} aria-label={pathTips}
                      onClick={() => { this.handleFlyStyleChange(uuid) }}
                ...
                return (
                  <div key={idx}>
                    <DropdownItem
                      className='dropdown-items' title={routeTips} aria-label={routeTips}
                      onClick={() => { this.handleFlyStyleChange(uuid) }}
      ...
      <Dropdown isOpen={this.state.isLiveView} toggle={this.toggleLiveviewSettingPopup} className='dropdowns liveview-btn'
        ...
        <DropdownMenu showArrow={false} css={getDropdownStyle(this.props.theme)}>
          ...
          {(flyStyle === FlyItemMode.Rotate) &&
            <div className='d-flex dropdown-items flex-column' role='group' aria-label={tilt}>
          ...
          {(flyStyle === FlyItemMode.Path) &&
            <div role='group' aria-label={altitude + " " + relative2Ground}>
