...
export default class LineFlyController extends BaseFlyController {
  ...
  getCameraByProgress = (progress?): CameraGL => {
    ...
    if (point0.type === 'line') {
      ...
      utils.worldUpAtPosition(camPosGL, worldUpVec, this.vec3, this.sceneView) // up-aux-line
      ...
      utils.worldUpAtPosition(basePosGL, worldUpVec, this.vec3, this.sceneView) // up-aux-line
